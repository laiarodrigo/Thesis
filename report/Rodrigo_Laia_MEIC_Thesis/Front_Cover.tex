...
\title{Recognizing and Translating Between Portuguese
Varieties with Fine-tuned Language Models}
...
% REQUIRED: Author
% Author full Name
\author{Rodrigo Farate Laia}
%
%
% -----------------------------------------------------------------------------
% REQUIRED: The SUPERVISOR(s) - maximum of two
\supervisor{Arlindo Oliveira, Bruno Martins}
