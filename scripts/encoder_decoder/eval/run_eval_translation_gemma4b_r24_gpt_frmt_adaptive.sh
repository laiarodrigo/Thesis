...
ADAPTER_DIR="${ADAPTER_DIR:-$REPO_ROOT/outputs/encoder_decoder/t5gemma2_4b_translation_lora_r24_gpt_frmt}"
OUTPUT_DIR="${OUTPUT_DIR:-$REPO_ROOT/eval_results/encoder_decoder/gemma4b/golden_collection/translation_lora_r24_gpt_frmt_adaptive_beam4}"
