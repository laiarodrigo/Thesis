...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Build a Stage B GPT+FRMT mix for translation and classification, "
    ...
    parser.add_argument(
        "--gpt-train",
        type=Path,
        default=repo_root / "data" / "encoder_decoder" / "t5gemma2" / "gpt_refresh_2st_20260312_2109" / "translation_train.jsonl",
    )
    parser.add_argument(
        "--gpt-valid",
        type=Path,
        default=repo_root / "data" / "encoder_decoder" / "t5gemma2" / "gpt_refresh_2st_20260312_2109" / "translation_valid.jsonl",
    )
    parser.add_argument(
        "--frmt-cls-train",
        type=Path,
    ...
    parser.add_argument(
        "--gpt-cls-train",
        type=Path,
        default=repo_root / "data" / "encoder_decoder" / "t5gemma2" / "gpt_refresh_2st_20260312_2109" / "classification_train.jsonl",
    )
    parser.add_argument(
        "--gpt-cls-valid",
        type=Path,
        default=repo_root / "data" / "encoder_decoder" / "t5gemma2" / "gpt_refresh_2st_20260312_2109" / "classification_valid.jsonl",
    )
    parser.add_argument(
        "--out-dir",
        type=Path,
        default=repo_root / "data" / "encoder_decoder" / "t5gemma2" / "compare_staged_v2" / "stageB_gpt_refresh2_frmt_mix",
    )
...
def main() -> None:
    ...
    translation_train_counts, frmt_train_kept_texts = write_mix(
        [(args.frmt_train, "FRMT"), (args.gpt_train, "GPT")],
    ...
    translation_valid_counts, frmt_valid_kept_texts = write_mix(
        [(args.frmt_valid, "FRMT"), (args.gpt_valid, "GPT")],
