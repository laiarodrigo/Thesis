...
OUT_DIR = os.environ.get("OUT_DIR", str(ROOT / "data/filter_shards"))
SHARDER = os.environ.get("SHARDER", str(ROOT / "src/shard_filter.py"))
...
THR = {
    ...
    "short_len": 8,
    "long_len": 28,
    # length-ratio outlier filter: len_pt / len_br
    "ratio_low": float(os.environ.get("RATIO_LOW", "0.5")),
    "ratio_high": float(os.environ.get("RATIO_HIGH", "2.0")),
}
